...
### How do I contribute?
See [CONTRIBUTING.md](https://github.com/LANCommander/LANCommander/blob/main/CONTRIBUTING.md) for build instructions and contribution guidelines. If you're not a developer, contributing to the [documentation](https://lancommander.app/) is a great way to help.
...
LANCommander is licensed under the [MIT License](https://github.com/LANCommander/LANCommander/blob/main/LICENSE).